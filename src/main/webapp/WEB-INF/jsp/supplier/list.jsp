...
<html lang="pt-br">
<head>
    <title><fmt:message key="title.page.suppliers" /> - <fmt:message key="title.purchasing" /></title>
    <html:head />
    <html:tableAssets/>
</head>
<body>
...
<html:jsAssets/>
<html:tableJsAssets/>
<script src="${pageContext.request.contextPath}/asset/js/custom/supplier.js "></script>
</html>
