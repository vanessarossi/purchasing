    ...
    <div class="modal fade" id="newTypeService" tabindex="-1" role="dialog" aria-labelledby="newTypeService" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form role="form" id="formTypeService" method="post" action='<c:url value="/tipoServico/salvar" ></c:url>'>
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                        <h4 class="modal-title"><fmt:message key="title.type.service" /></h4>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-7 col-md-7">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="description"  name="typeService.description" />
                                    <input type="hidden" name="typeService.id" id="id"  value="" />
                                </div>
                            </div>
                        </div>
                    </div>
